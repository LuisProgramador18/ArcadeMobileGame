...
public partial class LeaderBoardAlien : ContentPage
{
    public LeaderBoardAlien()
    {
        InitializeComponent();
    }
    ...
    {
        List<Puntaje> puntajeAlien = new List<Puntaje>();
        try
        {
                ...
                if (res.resultado)
                {
                    ...
                    foreach (var item in res.ListaDePuntajes)
                    {
                        ...
                        if (item.idJuego == 1)
                        {
                            ...
                            puntajeAlien.Add(item);
                        }

                    }
                    listScores.ItemsSource = puntajeAlien;
