...
public partial class LeaderBoardWorm : ContentPage
{
	public LeaderBoardWorm()
	{
		InitializeComponent();
	}
    ...
    {
        List<Puntaje> puntajeWorm = new List<Puntaje>();
        try
        {
                ...
                if (res.resultado)
                {
                    ...
                    foreach (var item in res.ListaDePuntajes)
                    {
                        ...
                        if (item.idJuego == 3)
                        {
                            ...
                            puntajeWorm.Add(item);
                        }

                    }

                    //Aquiiiii
                    listScores.ItemsSource = puntajeWorm;
